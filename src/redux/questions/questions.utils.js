...
export const AddToQuestionCollection = (question_collection, current_question) => {
    // console.log([...question_collection, current_question])
    return [...question_collection, current_question]
}
